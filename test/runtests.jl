...
@testset "1d regression" begin
    ...
    @test_throws DomainError FastChebInterp.chebvandermonde(x, 0.1, 0.9, 4)
    @test_throws DomainError FastChebInterp._chebvandermonde(xv,  SVector(0.1), SVector(0.9), (4,))
end
